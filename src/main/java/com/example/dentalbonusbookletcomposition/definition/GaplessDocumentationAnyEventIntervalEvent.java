...
@Generated(
    ...
    date = "2023-08-08T18:13:39.366432+02:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 2.0.0-SNAPSHOT"
)
@OptionFor("INTERVAL_EVENT")
public class GaplessDocumentationAnyEventIntervalEvent implements IntervalEventEntity, GaplessDocumentationAnyEventChoice {
  /**
  ...
  /**
   * Path: Dental_bonus_booklet/gapless_documentation/Any event/width
   */
  @Path("/width|value")
  private TemporalAmount widthValue;

  /**
   * Path: Dental_bonus_booklet/gapless_documentation/Any event/math_function
   */
  @Path("/math_function|defining_code")
  private MathFunction mathFunctionDefiningCode;

  /**
   * Path: Dental_bonus_booklet/gapless_documentation/Any event/sample_count
   */
  @Path("/sample_count")
